  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const metrics = [
        ...
        { key: "average_watch_time", value: parseFloat(formData.averageWatchTime), type: "number" }
      ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const filters = [
        ...
        { key: "subscribers_count", value: parseInt(formData.subscribersCount), type: "number" },
