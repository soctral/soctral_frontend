      ...
      existingData.forEach(item => {
        switch (item.key) {
          case "videos":
            ...
            break;
          case "total_likes":
            newData.totalLikes = item.value.toString();
            break;
          case "is_monetised":
            newData.monetised = item.value ? 'yes' : 'no';
            break;
          case "average_engagement":
            newData.averageEngagement = item.value.toString();
            break;
        }
      });
      setFormData(newData);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const metrics = [
        ...
        { key: "total_likes", value: parseInt(formData.totalLikes), type: "number" },
        { key: "is_monetised", value: formData.monetised === 'yes', type: "boolean" },
        { key: "average_engagement", value: parseFloat(formData.averageEngagement), type: "number" }
      ];
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-black/90 via-black/80 to-black/90 z-[10001] rounded-md flex items-center justify-center overflow-y-auto">
      <div className="bg-[#0D0D0D] rounded-lg p-6 w-full max-w-xl shadow-2xl my-8 max-h-[calc(100vh-4rem)] overflow-y-auto">
        ...
        <h2 className="text-white text-lg font-semibold mb-6 text-center">TikTok Metrics</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              step="0.01"
              className="w-full px-3 py-4 bg-[rgba(255,255,255,0.1)] text-xs rounded-full text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#613cd0]"
              placeholder="Enter Average Engagement"
            />
          </div>
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-black/90 via-black/80 to-black/90 z-[10001] rounded-md flex items-center justify-center overflow-y-auto">
      <div className="bg-[#0D0D0D] rounded-lg p-6 w-full max-w-xl shadow-2xl my-8 max-h-[calc(100vh-4rem)] overflow-y-auto">
        ...
        <h2 className="text-white text-lg font-semibold mb-6 text-center">TikTok Filters</h2>
