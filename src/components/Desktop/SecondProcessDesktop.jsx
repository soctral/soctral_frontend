...
// Network display names — matches buy/sell invoice form
...
// Static fallback networks per token (used when wallet data unavailable)
...
// Token → wallet currency key mappings (same as buy/sell)
...
const SecondProcessDesktop = ({ formData, onNext, onBack, onClose, walletData }) => {
          ...
          <div className="flex-1 overflow-y-auto px-6 py-2 custom-scrollbar">
            ...
            <div className="pb-6">
              ...
              <div className="space-y-5">
                {/* Deal Name */}
                <div>
                  <label className="block text-gray-400 text-sm mb-2">Deal Name</label>
                  <input 
                    type="text" 
                    placeholder="Enter Deal Name"
                    value={localData.dealName}
                    onChange={(e) => handleChange('dealName', e.target.value)}
                    className={`w-full bg-[#181818] border ${errors.dealName ? 'border-red-500' : 'border-white/10'} rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-primary transition-colors`}
                  />
                  {errors.dealName && <p className="text-red-500 text-xs mt-1.5">{errors.dealName}</p>}
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea 
                      ...
                      className={`w-full bg-[#181818] border ${errors.description ? 'border-red-500' : 'border-white/10'} rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-primary resize-none transition-colors`}
                    ></textarea>
                ...
                <div ref={searchRef}>
                  <label className="block text-gray-400 text-sm mb-2">Select Deal Partner</label>
                  ...
                  {localData.partnerId ? (
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        className={`w-full bg-[#181818] border ${errors.dealPartner ? 'border-red-500' : 'border-white/10'} rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-primary transition-colors`}
                      />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    {localData.dealImages.length < MAX_IMAGES && (
                      <label className="w-28 h-28 border border-dashed border-white/20 rounded-xl flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-white/5 hover:border-white/40 transition-colors bg-[#181818]">
                  ...
                  {errors.dealImages && <p className="text-red-500 text-xs mt-1.5">{errors.dealImages}</p>}
                </div>
...
export default SecondProcessDesktop;
